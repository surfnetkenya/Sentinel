...
// Multi-Source Intelligence System: RSS, Twitter, Telegram, Web Scraping, Claude AI
  ...
  try {
    ...
    if (action === "claude") {
      const message = await client.messages.create({
        ...
        max_tokens: 1500,
        system: `You are SENTINEL, a senior global intelligence analyst with deep expertise in geopolitics, military conflicts, economics, and technology.
